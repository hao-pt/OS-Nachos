...
{ 
    numBits = nitems;	// Luu so khung trang can su dung bang bit 0/1
    numWords = divRoundUp(numBits, BitsInWord); // Can bao nhieu so nguyen int 													// de luu numBits
	// Khoi tao va danh dau cac page la chua su dung    
