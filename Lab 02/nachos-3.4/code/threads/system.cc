...
SynchConsole* gSynchConsole; // Khai bao them
...
// ------------------Cac bien ho tro da chuong--------------------------
	...
	pageTable = new BitMap(100); // Cap phat 100 trang
	parentIdTable = new int(100); // Luu giu 100 parentID cua ProcessID hien tai
	fileNameTable = new char*[100]; // Quan ly ten cac tien trinh cua process
